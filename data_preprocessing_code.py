...
for dataset_number in range(1, 6):
    ...
    file = h5py.File('isotropic8192_' + str(dataset_number) + '.h5', 'r')
    filep = h5py.File('isotropic8192_' + str(dataset_number) + '_pressure.h5', 'r')
    keys = list(file.keys())
    key = list(filep.keys())
    print(keys)
    print(key)
...
#        #save all figures
#        
#        directory = 'isotropic4096_' + str(dataset_number) + 'b_figures/'
#        
...
#        fig18.savefig(dir18)
    ...
    filename = 'isotropic8192_' + str(dataset_number) + 'g_processed.h5'
